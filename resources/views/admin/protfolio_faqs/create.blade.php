...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="card">
            <form method="POST" action="{{ route('admin.protfolio.protfolioFaqs.store', ['protfolio_id' => request()->route('protfolio_id')]) }}" accept-charset="UTF-8">
                @csrf
            <div class="card-body">
                <div class="row">
